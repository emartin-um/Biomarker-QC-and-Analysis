...
params:
  ...
  output_dir: "output_files_n2850_2026Mar"
editor: visual
---
...
8.  **Save RDS** - Write `preprocessed_data.rds` with data + biomarker_cols
...
if (INCLUDE_DERIVED_COVARS) {
  ...
  dx_config <- make_category_config(
    ...
    collapse = list(
      ...
      "Dementia_Other" = c("Dementia Undetermined", "Dementia Vascular", "Dementia Other", "Dementia", "Cognitively Impaired")
    ),
...
if (INCLUDE_DERIVED_COVARS) {
  ...
  wgs_path <- file.path("..", "Secondary_QC", "APOE",
                        "U19_Alamar_metadata_2026Jan16_with_WGSAPOE.csv")
  ...
  filtered_combined <- filtered_combined %>%
    mutate(
      ...
      APOE4_carrier    = grepl("4", APOE.geno_final),
